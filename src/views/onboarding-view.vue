      ...
      <div class="flex flex-col my-auto w-[605px] mx-auto self-center">
        <div class="flex justify-center">
          <div class="text-brand-secondary text-5xl font-black">
            <img
              src="@/assets/icons/musora-icon.svg"
              alt="Musora Logo"
              class="h-12"
            >
          </div>
        ...
        <div class="mt-12 mb-8">
          ...
          >
            <component
              :is="stepTitles[onboardingState.currentStep].component"
        ...
        <template v-if="onboardingState.currentStep === 2">
          <label class="flex flex-row items-center justify-center text-xs mt-12">
            <input
              v-model="onboardingState.agreedToMarketing"
              type="checkbox"
              class="checkbox me-2"
            >
...
import Sidebar from '@/components/ob-sidebar.vue';
